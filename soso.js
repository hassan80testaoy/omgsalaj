...
function plist(e){for(var a=document.createElement("ul"),r=0;r<6;r++){var n=e.feed.entry[r];if(r==e.feed.entry.length)break;for(var t="",l=0;l<n.link.length;l++)if("alternate"==n.link[l].rel){t=n.link[l].href;break}if(""!==t){var i=n.title.$t,c=n.media$thumbnail.url.replace("s72-c/","s400/"),d=document.createElement("li"),m=document.createElement("div");m.className="thumb";var p=document.createElement("a");p.className="rnav-img",p.href=t,p.style.background="url("+c+") no-repeat center center",p.style.backgroundSize="cover",m.appendChild(p);var h=document.createElement("div");h.className="rnav-conent";var v=document.createElement("h3");v.className="rnav-title";var s=document.createElement("a");s.href=t,s.innerText=i,v.appendChild(s),h.appendChild(v),d.appendChild(m),d.appendChild(h),a.appendChild(d)}}return a}
var cookieChoices = {};
