...
var head, newLine, el, title, link, ToC = "<nav class='table-of-contents' role='navigation'><span onclick='toc()'><i class='fa fa-bars'></i>Table of Contents</span><ul class='content-list' style='display:none'>";
