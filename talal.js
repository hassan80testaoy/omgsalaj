...
$(document).ready(function(){let e=0,t=$("#header-wrapper");$(window).scroll(function(){const n=$(window).scrollTop();n>e?t.css({opacity:"0",transition:"opacity .5s ease-out"}).delay(200).css({display:"none",transition:"none"}):t.css({opacity:"1",display:"block",transition:"opacity .5s ease-in"}),e=n})});
