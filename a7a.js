...
function createList(e) {
  ...
  for (var r = 0; r < 6; r++) {
    ...
    if (a !== "") {
      var i = t.title.$t;
      var l = t.media$thumbnail.url.replace("s72-c/", "s400/");
      ...
      imgLink.className = "rnav-img";
      imgLink.href = a;
      imgLink.style.background = "url(" + l + ") no-repeat center center";
      ...
      contentDiv.className = "rnav-content";

      var titleH3 = document.createElement("h3");
      titleH3.className = "rnav-title";

      var titleLink = document.createElement("a");
      titleLink.href = a;
      titleLink.textContent = i;
