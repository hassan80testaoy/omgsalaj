...
var head, newLine, el, title, link, ToC = "<nav class='table-of-contents' role='navigation'><span onclick='toc()'>جدول المحتويات<i class='fa fa-bars'></i></span><ul class='content-list' style='display:none'>";
